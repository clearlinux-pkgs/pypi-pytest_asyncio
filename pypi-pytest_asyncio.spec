...
Source0  : https://files.pythonhosted.org/packages/ed/e6/aea6b1b0203aea401693ed95b0c79fa9b67c2fd222cacf4fc7826baa7ad3/pytest-asyncio-0.18.1.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.18.1
cd %{_builddir}/pytest-asyncio-0.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644514704
...
cp %{_builddir}/pytest-asyncio-0.18.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pytest_asyncio/92a74693f02c8e78dd90b2014c52bc35a95bab86

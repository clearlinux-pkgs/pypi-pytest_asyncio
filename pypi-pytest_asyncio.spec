...
Source0  : https://files.pythonhosted.org/packages/8e/c4/453c52c659521066969523e87d85d54139bbd17b78f09532fb8eb8cdb58e/pytest_asyncio-0.26.0.tar.gz
...
%prep
%setup -q -n pytest_asyncio-0.26.0
cd %{_builddir}/pytest_asyncio-0.26.0
pushd ..
cp -a pytest_asyncio-0.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742912647

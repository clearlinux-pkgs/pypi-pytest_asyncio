...
Source0  : https://files.pythonhosted.org/packages/cd/ef/80107b9e939875ad613c705d99d91e4510dcf5fed29613ac9aecbcba0a8d/pytest-asyncio-0.23.6.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.23.6
cd %{_builddir}/pytest-asyncio-0.23.6
pushd ..
cp -a pytest-asyncio-0.23.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710858914

...
Source0  : https://files.pythonhosted.org/packages/84/bb/eb07ca1e79df7da714004fc25ddcffe4a6d9fcb70893eb77de5d504da8e4/pytest-asyncio-0.23.4.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.23.4
cd %{_builddir}/pytest-asyncio-0.23.4
pushd ..
cp -a pytest-asyncio-0.23.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706545846

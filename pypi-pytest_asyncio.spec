...
Source0  : https://files.pythonhosted.org/packages/74/98/acc4cf65e9296c0b03fd166df2e7018991a379d9a0fe8cabf8fc0b9ead29/pytest-asyncio-0.23.5.post1.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.23.5.post1
cd %{_builddir}/pytest-asyncio-0.23.5.post1
pushd ..
cp -a pytest-asyncio-0.23.5.post1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710173203

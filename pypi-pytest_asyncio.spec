...
Source0  : https://files.pythonhosted.org/packages/72/df/adcc0d60f1053d74717d21d58c0048479e9cab51464ce0d2965b086bd0e2/pytest_asyncio-0.25.2.tar.gz
...
%prep
%setup -q -n pytest_asyncio-0.25.2
cd %{_builddir}/pytest_asyncio-0.25.2
pushd ..
cp -a pytest_asyncio-0.25.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736348390

...
Source0  : https://files.pythonhosted.org/packages/13/d9/1dcac9b3fc6eccf8f1e3a657439c11ffc5cf762edd20f65577f832ba248b/pytest_asyncio-0.23.7.tar.gz
...
%prep
%setup -q -n pytest_asyncio-0.23.7
cd %{_builddir}/pytest_asyncio-0.23.7
pushd ..
cp -a pytest_asyncio-0.23.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716143521

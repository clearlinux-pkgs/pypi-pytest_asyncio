...
Source0  : https://files.pythonhosted.org/packages/f2/a8/ecbc8ede70921dd2f544ab1cadd3ff3bf842af27f87bbdea774c7baa1d38/pytest_asyncio-0.25.3.tar.gz
...
%prep
%setup -q -n pytest_asyncio-0.25.3
cd %{_builddir}/pytest_asyncio-0.25.3
pushd ..
cp -a pytest_asyncio-0.25.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738101250

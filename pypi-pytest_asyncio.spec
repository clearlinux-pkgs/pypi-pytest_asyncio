...
Source0  : https://files.pythonhosted.org/packages/d0/d4/14f53324cb1a6381bef29d698987625d80052bb33932d8e7cbf9b337b17c/pytest_asyncio-1.0.0.tar.gz
...
%prep
%setup -q -n pytest_asyncio-1.0.0
cd %{_builddir}/pytest_asyncio-1.0.0
pushd ..
cp -a pytest_asyncio-1.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748356301

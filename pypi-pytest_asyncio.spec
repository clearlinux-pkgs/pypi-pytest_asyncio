...
Source0  : https://files.pythonhosted.org/packages/eb/db/479f1c43df26c42c9797dfc866dc98bcf28d3765ae49bf2da681ab344b72/pytest-asyncio-0.20.2.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.20.2
cd %{_builddir}/pytest-asyncio-0.20.2
pushd ..
cp -a pytest-asyncio-0.20.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668448849

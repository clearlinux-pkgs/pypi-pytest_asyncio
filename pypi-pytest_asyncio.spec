...
Source0  : https://files.pythonhosted.org/packages/52/6d/c6cf50ce320cf8611df7a1254d86233b3df7cc07f9b5f5cbcb82e08aa534/pytest_asyncio-0.24.0.tar.gz
...
%prep
%setup -q -n pytest_asyncio-0.24.0
cd %{_builddir}/pytest_asyncio-0.24.0
pushd ..
cp -a pytest_asyncio-0.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724326863

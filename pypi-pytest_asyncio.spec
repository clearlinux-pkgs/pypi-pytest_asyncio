...
Source0  : https://files.pythonhosted.org/packages/24/05/6e2e679644466425126aeca57165723cdd56dfd1971c0aec4bc063ec0009/pytest-asyncio-0.22.0.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.22.0
cd %{_builddir}/pytest-asyncio-0.22.0
pushd ..
cp -a pytest-asyncio-0.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698766818

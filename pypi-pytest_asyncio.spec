...
Source0  : https://files.pythonhosted.org/packages/de/b4/0b378b7bf26a8ae161c3890c0b48a91a04106c5713ce81b4b080ea2f4f18/pytest_asyncio-0.23.8.tar.gz
...
%prep
%setup -q -n pytest_asyncio-0.23.8
cd %{_builddir}/pytest_asyncio-0.23.8
pushd ..
cp -a pytest_asyncio-0.23.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721318431

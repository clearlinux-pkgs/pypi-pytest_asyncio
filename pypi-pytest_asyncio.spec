...
Source0  : https://files.pythonhosted.org/packages/5d/cb/0c7513d6da3a148dbd315396243fa61bfa150c188aba76bf78024f274838/pytest-asyncio-0.17.1.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.17.1
cd %{_builddir}/pytest-asyncio-0.17.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642440759
...
cp %{_builddir}/pytest-asyncio-0.17.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pytest_asyncio/92a74693f02c8e78dd90b2014c52bc35a95bab86

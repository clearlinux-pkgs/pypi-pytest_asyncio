...
Source0  : https://files.pythonhosted.org/packages/4e/51/f8794af39eeb870e87a8c8068642fc07bce0c854d6865d7dd0f2a9d338c2/pytest_asyncio-1.1.0.tar.gz
...
%prep
%setup -q -n pytest_asyncio-1.1.0
cd %{_builddir}/pytest_asyncio-1.1.0
pushd ..
cp -a pytest_asyncio-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752667444

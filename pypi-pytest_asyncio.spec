...
Source0  : https://files.pythonhosted.org/packages/fd/b1/d6648bfeaf1814be74c9a8a001302315374185955a217ffaca2692a78d5b/pytest-asyncio-0.17.2.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.17.2
cd %{_builddir}/pytest-asyncio-0.17.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642448934
...
cp %{_builddir}/pytest-asyncio-0.17.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pytest_asyncio/92a74693f02c8e78dd90b2014c52bc35a95bab86

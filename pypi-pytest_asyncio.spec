...
Source0  : https://files.pythonhosted.org/packages/1d/27/f036ec4bcbfd056c54572d7169ba3dbb54e7181f02f21caadd3aecb9cf5b/pytest-asyncio-0.23.3.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.23.3
cd %{_builddir}/pytest-asyncio-0.23.3
pushd ..
cp -a pytest-asyncio-0.23.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704141399

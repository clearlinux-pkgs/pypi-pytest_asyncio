...
Source0  : https://files.pythonhosted.org/packages/61/26/e0d399fc08f1ce8f03fd308334858342a73fb1fc55b74cbbd0b96b3ad5f7/pytest-asyncio-0.23.5.tar.gz
...
%prep
%setup -q -n pytest-asyncio-0.23.5
cd %{_builddir}/pytest-asyncio-0.23.5
pushd ..
cp -a pytest-asyncio-0.23.5 buildavx2
popd
pushd ..
cp -a pytest-asyncio-0.23.5 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707669122
